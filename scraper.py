...
NEGATIVES = [
  ...
  ("Internship / apprenticeship / student role", ["ausbildung","ausbildungsplatz","apprentice","apprenti","lehrling","azubi","werkstudent","working student","studentische","praktikum","praktikant","internship","duales studium","dual study","dual-study","dualer student","duale studentin","trainee","bachelorarbeit","masterarbeit","abschlussarbeit","diplomarbeit"," thesis"]),
...
def make_job(title, co, loc, country, url, posted, source, desc=""):
    ...
    j["offtype"] = is_offtype(title + " " + (desc or ""))
